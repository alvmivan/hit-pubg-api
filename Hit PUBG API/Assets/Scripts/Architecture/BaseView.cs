...
namespace Architecture
{
    public class BaseView : MonoBehaviour
    {
        ...
        protected virtual void OnEnable() => viewEnabled.OnNext(Unit.Default);
        protected virtual void OnDisable() => viewEnabled.OnNext(Unit.Default);
        protected virtual void OnDestroy() => viewCleanup.OnNext(Unit.Default);
    }
}